...
export default class GameEvent {
    ...
    public static Show_Gold_Fly_End:string ="Show_Gold_Fly_End";
    //升级
    ...
    //农场状态变化
    public static Farm_State_Change:string = "Farm_State_Change";

    //收集树
    public static Pick_Tree:string ="Pick_Tree";
    //升级树
    ...
    //解锁地块改变
    public static Unlock_Change:string ="Unlock_Change";
}
