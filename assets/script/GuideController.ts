...
export default class GuideController{
    ...
    public initGuide():void{
        var guideCfg =[
            {id:1,type:1,scene:"farm",message:"欢迎来到花田田，开始建设花园吧"},
            {id:2,type:1,scene:"farm",message:"点击种植第一块花田"},
            {id:3,type:2,scene:"farm",node:"firstFarmland"},
            {id:4,type:1,scene:"farm",message:"花田会持续生产金币，点击收集金币"},
            ...
            {id:9,type:1,scene:"farm",message:"满级可以种植更高等级的鲜花，连续点击升级"},
            ...
            {id:17,type:1,scene:"game",message:"再试一次看看"},
