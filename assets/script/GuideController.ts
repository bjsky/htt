...
export default class GuideController{
    ...
    public initGuide():void{
        var guideCfg =[
            ...
            {id:9,type:1,scene:"farm",message:"满级可以收集鲜花，解锁更多花田"},
            ...
            {id:14,type:1,scene:"farm",message:"滑动屏幕连续收集两块花田"},
            {id:15,type:3,scene:"farm",node:"pickTwo"},
            {id:16,type:1,scene:"farm",message:"转盘抽奖可以快速获取金币，去试试运气"},
            {id:17,type:2,scene:"farm",node:"toSlot"},
            {id:18,type:2,scene:"game",node:"startSlot"},
            {id:19,type:1,scene:"game",message:"再来一次"},
            {id:20,type:2,scene:"game",node:"startSlot"},
            {id:21,type:1,scene:"game",message:"有了金币，现在去解锁更多花田吧"},
            {id:22,type:2,scene:"game",node:"toFarm"},
